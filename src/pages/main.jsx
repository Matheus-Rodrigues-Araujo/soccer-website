    ...
    return(
      <div className="px-4 pt-5 my-3 text-center border-bottom">
        ...
        <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
            <button type="button" className="btn  btn-lg px-4 me-sm-3" style={{backgroundColor:'#39ff2c'}}>Explore</button>
        ...
        <h2 className="display-4 fw-bold text-body-emphasis my-5">Categories</h2>
